...
namespace IntegralSolverApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double trapeziodalIntegralSolverResult = trapeziodalIntegralSolver.CalculateIntegral(lowerBound, upperBound);
            double parabolicIntegralSolverResult = parabolicIntegralSolver.CalculateIntegral(lowerBound, upperBound);
